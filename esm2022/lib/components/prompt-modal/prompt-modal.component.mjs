...
export class PromptModalComponent {
    ...
    static { this.ɵfac = function PromptModalComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || PromptModalComponent)(i0.ɵɵdirectiveInject(i1.BsModalRef)); }; }
