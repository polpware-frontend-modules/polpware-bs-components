...
class BreadcrumbComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: BreadcrumbComponent, selectors: [["polp-bs-breadcrumb"]], inputs: { items: "items", listClasses: "listClasses", inactiveItemClasses: "inactiveItemClasses", activeItemClasses: "activeItemClasses" }, standalone: false, features: [i0.ɵɵNgOnChangesFeature], decls: 3, vars: 3, consts: [[3, "ngClass"], [3, "ngClass", 4, "ngFor", "ngForOf"], ["aria-current", "page", 3, "ngClass", 4, "ngIf"], [3, "ngSwitch"], [3, "href", 4, "ngSwitchCase"], [3, "routerLink", "queryParams", 4, "ngSwitchCase"], [3, "click", 4, "ngSwitchCase"], [4, "ngSwitchDefault"], [3, "href"], [3, "routerLink", "queryParams"], [3, "click"], ["aria-current", "page", 3, "ngClass"]], template: function BreadcrumbComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [i1.NgClass, i1.NgForOf, i1.NgIf, i1.NgSwitch, i1.NgSwitchCase, i1.NgSwitchDefault, i2.RouterLink], encapsulation: 2 }); }
}
...
class AlertBoxComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AlertBoxComponent, selectors: [["polp-bs-alert-box"]], hostBindings: function AlertBoxComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        } }, inputs: { hideNoBtn: "hideNoBtn", yesBtnLabel: "yesBtnLabel", noBtnLabel: "noBtnLabel", noBtnClasses: "noBtnClasses", yesBtnClasses: "yesBtnClasses", enableEnter: "enableEnter", title: "title", innerBody: "innerBody" }, standalone: false, decls: 10, vars: 5, consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], [1, "modal-body"], [3, "innerHtml"], [1, "modal-footer"], ["type", "button", "class", "btn me-2", 3, "ngClass", "click", 4, "ngIf"], ["type", "button", 1, "btn", 3, "click", "ngClass"], ["type", "button", 1, "btn", "me-2", 3, "click", "ngClass"]], template: function AlertBoxComponent_Template(rf, ctx) { if (rf & 1) {
...
function PromptFormComponent_div_1_ng_container_1_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    const isFirst_r10 = ctx_r8.first;
    i0.ɵɵadvance();
    i0.ɵɵpropertyInterpolate("for", elem_r1.fieldId);
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1(" ", elem_r1.label, " ");
    ...
    i0.ɵɵproperty("autofocus", isFirst_r10);
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("ngForOf", elem_r1.options);
} }
...
function PromptFormComponent_div_1_ng_container_1_ng_container_8_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtemplate(0, PromptFormComponent_div_1_ng_container_1_ng_container_8_ng_template_6_input_0_Template, 1, 8, "input", 55);
} if (rf & 2) {
    const elem_r1 = i0.ɵɵnextContext(3).$implicit;
...
function PromptFormComponent_div_1_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(2, PromptFormComponent_div_1_ng_container_1_ng_container_2_Template, 7, 7, "ng-container", 26)(3, PromptFormComponent_div_1_ng_container_1_ng_container_3_Template, 4, 3, "ng-container", 26)(4, PromptFormComponent_div_1_ng_container_1_ng_container_4_Template, 9, 10, "ng-container", 26)(5, PromptFormComponent_div_1_ng_container_1_ng_container_5_Template, 7, 10, "ng-container", 26)(6, PromptFormComponent_div_1_ng_container_1_ng_container_6_Template, 9, 11, "ng-container", 26)(7, PromptFormComponent_div_1_ng_container_1_ng_container_7_Template, 7, 9, "ng-container", 26)(8, PromptFormComponent_div_1_ng_container_1_ng_container_8_Template, 8, 6, "ng-container", 27);
    i0.ɵɵelementContainerEnd()();
} if (rf & 2) {
...
class PromptModalComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PromptModalComponent, selectors: [["polp-bs-prompt-modal"]], inputs: { autocomplete: "autocomplete", enableEnter: "enableEnter", hideCancelBtn: "hideCancelBtn", hideConfirmBtn: "hideConfirmBtn", hideCloseBtn: "hideCloseBtn", cancelBtnLabel: "cancelBtnLabel", confirmBtnLabel: "confirmBtnLabel", cancelBtnClasses: "cancelBtnClasses", confirmBtnClasses: "confirmBtnClasses", title: "title", innerBody: "innerBody", fields: "fields" }, outputs: { result: "result" }, standalone: false, decls: 7, vars: 12, consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", "class", "btn-close", "aria-label", "Close", 3, "click", 4, "ngIf"], [1, "modal-body"], [3, "innerHtml"], [3, "onCancel", "onSave", "fields", "hideCancelBtn", "hideSubmitBtn", "cancelBtnTxt", "submitBtnTxt", "cancelBtnClasses", "submitBtnClasses", "autocomplete", "enableEnter"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"]], template: function PromptModalComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [i1.NgIf, PromptFormComponent], encapsulation: 2 }); }
}
...
class ExpandableCardComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ExpandableCardComponent, selectors: [["polp-bs-expandable-card"]], inputs: { isCollapsed: "isCollapsed", titleClass: "titleClass" }, standalone: false, ngContentSelectors: _c1, decls: 6, vars: 6, consts: [[1, "card"], [1, "card-header", 3, "click"], [3, "icon"], [1, "card-body", 3, "id", "collapse", "isAnimated"]], template: function ExpandableCardComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [i1$3.CollapseDirective, i4.FaIconComponent], encapsulation: 2 }); }
}
...
class SearchBoxWidgetComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SearchBoxWidgetComponent, selectors: [["polp-bs-search-box-widget"]], viewQuery: function SearchBoxWidgetComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [i1.NgClass, i1.NgIf, i1$2.ɵNgNoValidate, i1$2.DefaultValueAccessor, i1$2.NgControlStatus, i1$2.NgControlStatusGroup, i1$2.NgForm, i1$2.FormControlDirective, i4.FaIconComponent, i5.AutofocusDirective], encapsulation: 2 }); }
}
...
class PageSizeOptionsWidgetComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PageSizeOptionsWidgetComponent, selectors: [["polp-bs-page-size-options-widget"]], inputs: { initSize: "initSize", options: "options" }, outputs: { onChange: "onChange" }, standalone: false, decls: 3, vars: 1, consts: [["aria-label", "page size options"], [1, "pagination"], [4, "ngFor", "ngForOf"], [1, "page-item", 3, "ngClass"], [1, "page-link", 3, "click"]], template: function PageSizeOptionsWidgetComponent_Template(rf, ctx) { if (rf & 1) {
