...
export declare abstract class ObservableModalAbstractComponent<TInput, TOutput> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ObservableModalAbstractComponent<any, any>, never, never, { "modalId": { "alias": "modalId"; "required": false; }; }, {}, never, never, false, never>;
}
